...
class UnregisterClientTickFunction(private val luaManager: LuaManager) : OneArgFunction() {
    override fun call(callback: LuaValue): LuaValue {
        return LuaValue.valueOf(luaManager.removeClientTickCallback(callback))
    }
}