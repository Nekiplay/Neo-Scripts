...
object ServerUtil {
    ...
    fun getSequence() : Int {
        mc.level?.blockStatePredictionHandler?.startPredicting()
        mc.level?.blockStatePredictionHandler?.close()
        return mc.level?.blockStatePredictionHandler?.currentSequence() ?: 0
    }
