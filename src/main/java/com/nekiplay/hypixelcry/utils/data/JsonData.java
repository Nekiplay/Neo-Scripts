package com.nekiplay.hypixelcry.utils.data;
...
public class JsonData<T> {
    ...
    private void loadInternal() {
        try (BufferedReader reader = Files.newBufferedReader(file)) {
            ...
            data = codec.parse(compressed ? JsonOps.COMPRESSED : JsonOps.INSTANCE, HypixelCry.GSON.fromJson(reader, JsonObject.class)).getOrThrow();
    ...
    private void saveInternal() {
        ...
        try (BufferedWriter writer = Files.newBufferedWriter(file)) {
            HypixelCry.GSON.toJson(codec.encodeStart(compressed ? JsonOps.COMPRESSED : JsonOps.INSTANCE, data).getOrThrow(), writer);
        } catch (Exception e) {
