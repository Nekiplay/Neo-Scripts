...
import static com.nekiplay.hypixelcry.HypixelCry.CONFIG_DIR;
import static com.nekiplay.hypixelcry.HypixelCry.neuDir;
...
public class NEURepoManager {
    ...
    public static void init() {
        ClientCommandRegistrationCallback.EVENT.register((dispatcher, registryAccess) ->
                dispatcher.register(ClientCommandManager.literal(HypixelCry.MOD_ID)
