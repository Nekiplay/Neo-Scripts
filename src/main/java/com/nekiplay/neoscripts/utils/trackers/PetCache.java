...
import com.nekiplay.neoscripts.utils.data.ProfiledData;
import com.nekiplay.neoscripts.utils.itemlist.ItemRepository;
import com.nekiplay.neoscripts.utils.itemlist.PetInfo;
import com.nekiplay.neoscripts.utils.itemlist.SkyblockItemRarity;
...
public class PetCache {
    private static final Path FILE = Main.CONFIG_DIR.resolve("pet_cache.json");
