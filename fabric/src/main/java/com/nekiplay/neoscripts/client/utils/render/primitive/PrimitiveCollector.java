...
public interface PrimitiveCollector {
     ...
     * @param segments The number of triangles used to approximate the circle.
     */
    void submitFilledCircle(Vec3 centre, float radius, int segments, int colour, boolean throughWalls);
     ...
     * @param segments  The number of triangles used to approximate the circle.
     */
    void submitOutlinedCircle(Vec3 centre, float radius, float thickness, int segments, int colour, boolean throughWalls);
}