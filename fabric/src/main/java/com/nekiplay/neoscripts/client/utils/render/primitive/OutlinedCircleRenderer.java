...
import com.nekiplay.neoscripts.client.utils.render.state.OutlinedCircleRenderState;
...
public final class OutlinedCircleRenderer implements PrimitiveRenderer<OutlinedCircleRenderState> {
    ...
    public void submitPrimitives(OutlinedCircleRenderState state, CameraRenderState cameraState) {
        VertexConsumer buffer = Renderer.getBuffer(state.walls() ? SkyblockerRenderPipelines.CIRCLE_LINES_THROUGH_WALLS : SkyblockerRenderPipelines.CIRCLE_LINES);
