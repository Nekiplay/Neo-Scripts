package com.nekiplay.neoscripts.client.features.lua.objects.world
    ...
    private class GetRotationFunction : ThreeArgFunction() {
        override fun call(
            ...
            return if (arg1?.isnumber() == true && arg2?.isnumber() == true && arg3?.isnumber() == true) {
                val yaw = RotationUtils.getYaw(Vec3(arg1.todouble(), arg2.todouble(), arg3.todouble()))
                val pitch = RotationUtils.getPitch(Vec3(arg1.todouble(), arg2.todouble(), arg3.todouble()))
                val table = tableOf()
