...
import com.nekiplay.neoscripts.client.features.lua.objects.misc.imgui.ImDrawCommandQueue
import com.nekiplay.neoscripts.client.features.lua.objects.misc.imgui.ImGuiFont
import com.nekiplay.neoscripts.client.features.lua.objects.misc.imgui.ImGuiTexture
import imgui.ImFont
...
class ImGuiLib(val script: LuaClientScript) : LuaValue() {
    ...
    fun onGlfwInit() {
        if (windowHandle == -1L) {
            ...
            windowHandle = ClientMain.mc.window.handle()
