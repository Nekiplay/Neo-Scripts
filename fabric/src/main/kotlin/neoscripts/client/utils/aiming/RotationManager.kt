package com.nekiplay.neoscripts.client.utils.aiming

import com.nekiplay.neoscripts.ClientMain.mc
import com.nekiplay.neoscripts.client.events.ApplyInputEvent
import com.nekiplay.neoscripts.client.events.ExtractRenderStateEvent
import com.nekiplay.neoscripts.client.events.PacketEvent
import com.nekiplay.neoscripts.client.events.PlayerTickEvent
import com.nekiplay.neoscripts.client.events.RaycastHitEvent
import com.nekiplay.neoscripts.client.events.RenderEvent
import com.nekiplay.neoscripts.client.events.SyncPosEvent
...
import com.nekiplay.neoscripts.client.utils.animation.AnimationUtil
...
object RotationManager {
    ...
    fun onApplyInput(event : ApplyInputEvent) {
        ...
        if (!yaw.isNaN()) {
            ...
            mc.player?.input?.moveVector = Vec2(
    ...
    fun onPacketSend(event : PacketEvent.Send) {
        ...
        if (event.packet is ServerboundUseItemPacket) {
            ...
            if (packet.yRot != getCurrentYaw() || packet.xRot != getCurrentPitch()) {
                packet.yRot = getCurrentYaw()
                packet.xRot = getCurrentPitch()
